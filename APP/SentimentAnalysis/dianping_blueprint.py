...
app_dianping = Blueprint("sentimentanalysis", __name__, static_folder=ASSETS_DIR, template_folder='templates')


@app_dianping.route('/', methods=["GET"])
def index():
...
# 文本摘要提取
@app_dianping.route('/show', methods=['POST'])
